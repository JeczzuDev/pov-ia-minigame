        ...
        <div className="space-y-2">
          {sortedData.map((entry, index) => (
            <div 
              ...
              className={`relative flex items-center justify-between p-3 rounded-lg transition-all duration-200 hover:bg-black/15 ${
                index < 3 ? 'bg-gradient-to-r ' + getPositionColor(index) : 'bg-black/25'
              }`}
            >
